...
#define SW1 GPIO_NUM_26 // sw1
#define SW2 GPIO_NUM_27 // sw2
...
void app_main()
{
    ...
    while (true)
    {
        ...
        {
            ESP_LOGI(TAG, "Switch 1 is off. %d", recdata);
            gpio_set_level(SW1, 1);
        }
        else if (recdata == 2)
        {
            ESP_LOGI(TAG, "Switch 1 is on. %d", recdata);
            gpio_set_level(SW1, 0);
        }
        else if (recdata == 3)
        {
            ESP_LOGI(TAG, "Switch 2 is off. %d", recdata);
            gpio_set_level(SW2, 1);
        }
        else if (recdata == 4)
        {
            ESP_LOGI(TAG, "Switch 2 is on. %d", recdata);
